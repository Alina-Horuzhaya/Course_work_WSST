#include "stdafx.h"   //код переделан и готов к сдаче
#include <iostream>
#include <string>
#include <cmath> 
#include <stdlib.h>
...
void pure_Alloha(double NTL, int T, int NOP, int cores);  
...
int main()
{
	...
	cout << "Тест метода Чистая Аллоха" << endl;
	cout << endl;
	...
	cout << "Для нормированной пропускной нагрузки = " << NTL_1 << " и " << "временного интервала = " << T_1 << '\n';
	cout << '|';
	pure_Alloha(NTL_1, T_1, NOP_2, cores);
	cout << endl;
	cout << "Для нормированной пропускной нагрузки = " << NTL_2 << " и " << "временного интервала = " << T_1 << '\n';
	cout << '|';
	pure_Alloha(NTL_2, T_1, NOP_2, cores);
	cout << endl;
	cout << "Для нормированной пропускной нагрузки = " << NTL_3 << " и " << "временного интервала = " << T_1 << '\n';
	cout << '|';
	pure_Alloha(NTL_3, T_1, NOP_2, cores);
	cout << endl;
	...
	cout << "Для нормированной пропускной нагрузки = " << NTL_1 << " и " << "временного интервала = " << T_2 << '\n';
	cout << '|';
	pure_Alloha(NTL_1, T_2, NOP_2, cores);
	cout << endl;
	cout << "Для нормированной пропускной нагрузки = " << NTL_2 << " и " << "временного интервала = " << T_2 << '\n';
	cout << '|';
	pure_Alloha(NTL_2, T_2, NOP_2, cores);
	cout << endl;
	cout << "Для нормированной пропускной нагрузки = " << NTL_3 << " и " << "временного интервала = " << T_2 << '\n';
	cout << '|';
	pure_Alloha(NTL_3, T_2, NOP_2, cores);
	cout << endl;
	...
	cout << "Для нормированной пропускной нагрузки = " << NTL_1 << " и " << "временного интервала = " << T_3 << '\n';
	cout << '|';
	pure_Alloha(NTL_1, T_3, NOP_2, cores);
	cout << endl;
	cout << "Для нормированной пропускной нагрузки = " << NTL_2 << " и " << "временного интервала = " << T_3 << '\n';
	cout << '|';
	pure_Alloha(NTL_2, T_3, NOP_2, cores);
	cout << endl;
	cout << "Для нормированной пропускной нагрузки = " << NTL_3 << " и " << "временного интервала = " << T_3 << '\n';
	cout << '|';
	pure_Alloha(NTL_3, T_3, NOP_2, cores);
	cout << endl;
	...
	cout << "Для нормированной пропускной нагрузки = " << NTL_1 << " и " << "временного интервала = " << T_1 << '\n';
	cout << '|';
	pure_Alloha(NTL_1, T_1, NOP_3, cores);
	cout << endl;
	cout << "Для нормированной пропускной нагрузки = " << NTL_2 << " и " << "временного интервала = " << T_1 << '\n';
	cout << '|';
	pure_Alloha(NTL_2, T_1, NOP_3, cores);
	cout << endl;
	cout << "Для нормированной пропускной нагрузки = " << NTL_3 << " и " << "временного интервала = " << T_1 << '\n';
	cout << '|';
	pure_Alloha(NTL_3, T_1, NOP_3, cores);
	cout << endl;
	...
	cout << "Для нормированной пропускной нагрузки = " << NTL_1 << " и " << "временного интервала = " << T_2 << '\n';
	cout << '|';
	pure_Alloha(NTL_1, T_2, NOP_3, cores);
	cout << endl;
	cout << "Для нормированной пропускной нагрузки = " << NTL_2 << " и " << "временного интервала = " << T_2 << '\n';
	cout << '|';
	pure_Alloha(NTL_2, T_2, NOP_3, cores);
	cout << endl;
	cout << "Для нормированной пропускной нагрузки = " << NTL_3 << " и " << "временного интервала = " << T_2 << '\n';
	cout << '|';
	pure_Alloha(NTL_3, T_2, NOP_3, cores);
	cout << endl;
	...
	cout << "Для нормированной пропускной нагрузки = " << NTL_1 << " и " << "временного интервала = " << T_3 << '\n';
	cout << '|';
	pure_Alloha(NTL_1, T_3, NOP_3, cores);
	cout << endl;
	cout << "Для нормированной пропускной нагрузки = " << NTL_2 << " и " << "временного интервала = " << T_3 << '\n';
	cout << '|';
	pure_Alloha(NTL_2, T_3, NOP_3, cores);
	cout << endl;
	cout << "Для нормированной пропускной нагрузки = " << NTL_3 << " и " << "временного интервала = " << T_3 << '\n';
	cout << '|';
	pure_Alloha(NTL_3, T_3, NOP_3, cores);
	cout << endl;
...
void pure_Alloha(double NTL, int T, int NOP, int cores) {
	{
		int i = 0;
		double P = exp(-2 * NTL); // вероятность прохождения кадра
		...
		double S = RG * exp(-2 * RG); //нормированная производительность
